    ...
    <body data-sidebar="dark">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="{{ asset('public/backend/images/users/user-4.jpg') }}"
                                    alt="Header Avatar">
                            </button>
                            <div class="dropdown-menu dropdown-menu-right">
                                <!-- item-->
                                <a class="dropdown-item" href="{{ route('user_profile') }}"><i class="mdi mdi-account-circle font-size-17 align-middle mr-1"></i> Profile</a>
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                           ...
                           {{--   <li>
                                <a href="{{ route('userList') }}" class=" waves-effect">
                                    <i class="fa fa-users"><span class="fa fa-plus"></span></i>
                                    <span>Add Users</span>
                                </a>
                            </li> --}}
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('studentClassview') }}">Student Class</a></li>
                                    <li><a href="{{ route('studentyearview') }}">Student Year(Session)</a></li>
                                    <li><a href="{{ route('studentGroupview') }}">Student Group</a></li>
                                    <li><a href="{{ route('studentShiftview') }}">Student Shift</a></li>
                                    <li><a href="{{ route('FeeCategoryview') }}">Fee Category</a></li>
                                    <li><a href="{{ route('FeeAmmountview') }}">Fee Category Ammount</a></li>
                                    <li><a href="{{ route('ExamTypeview') }}">Exam Type</a></li>
                                    <li><a href="{{ route('Subjectview') }}">Subject Manage</a></li>
                                    <li><a href="{{ route('AssignSubjectview') }}">Assign Subject</a></li>
                                    <li><a href="{{ route('Designationview') }}">Designation</a></li>
                                </ul>
                            </li>
                             ...
                             <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('Student_regview') }}">Student Registation</a></li>
                                    <li><a href="{{ route('Student_Rollview') }}">Roll Genarate</a></li>
                                    <li><a href="{{ route('Student_RegisFee') }}">Registation Fee</a></li>
                                    <li><a href="{{ route('Student_MonthlyFee') }}">Monthly Fee</a></li>
                                    <li><a href="{{ route('Student_ExamFee') }}">Exam Fee</a></li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('Employ_regview') }}">Employe Registation</a></li>
                                    <li><a href="{{ route('Employ_Salaryview') }}">Employe Salary</a></li>
                                    <li><a href="{{ route('Employ_Leaveview') }}">Employe Leave</a></li>
                                    <li><a href="{{ route('Employ_Attendanceview') }}">Employe Attendance</a></li>
                                    <li><a href="{{ route('Employ_monthSalaryview') }}">Employe Month Salary</a></li>
                             ...
                             <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('Employ_markEntyadd') }}">Mark Entry</a></li>
                                    <li><a href="{{ route('Employ_markEntyedite') }}">Edite Mark</a></li>
                                    <li><a href="{{ route('GrapdePointview') }}">Grade Point</a></li>
                                 {{--    <li><a href="{{ route('Employ_Salaryview') }}">Employe Salary</a></li>
                                    <li><a href="{{ route('Employ_Leaveview') }}">Employe Leave</a></li>
                                    <li><a href="{{ route('Employ_Attendanceview') }}">Employe Attendance</a></li>
                                    <li><a href="{{ route('Employ_monthSalaryview') }}">Employe Month Salary</a></li> --}}
        ...
        <div class="right-bar">
            <div data-simplebar class="h-100">
                ...
                <div class="p-4">
                    ...
                    <div class="custom-control custom-switch mb-3">
                        <input type="checkbox" class="custom-control-input theme-choice" id="dark-mode-switch" data-bsStyle="{{ asset('public/backend/css/bootstrap-dark.min.css') }}" 
                    ...
                    <div class="custom-control custom-switch mb-5">
                        <input type="checkbox" class="custom-control-input theme-choice" id="rtl-mode-switch" data-appStyle="{{ asset('public/backend/css/app-rtl.min.css') }}" />
      ...
      {{--   <script src="{{ asset('public/backend/js/jquery-3.2.1.min.js') }}"></script>
        ...
        <script src="{{ asset('public/backend/libs/datatables.net-buttons-bs4/js/buttons.bootstrap4.min.js') }}"></script>
            ...
            <script src="{{ asset('public/backend/libs/datatables.net-buttons/js/buttons.html5.min.js') }}"></script>
        <script src="{{ asset('public/backend/libs/datatables.net-buttons/js/buttons.print.min.js') }}"></script>
        <script src="{{ asset('public/backend/libs/datatables.net-buttons/js/buttons.colVis.min.js') }}"></script>
        <!-- Responsive examples -->
        ...
        <script src="{{ asset('public/backend/js/app.js') }}"></script>
         ...
         <script src="{{ asset('public/backend/js/handlebar.js') }}"></script>
