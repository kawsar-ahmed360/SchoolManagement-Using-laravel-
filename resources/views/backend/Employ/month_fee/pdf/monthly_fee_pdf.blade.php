...
<div class="container">
	 ...
	 <div class="row">
	 	...
	 	<div class="col-md-12" style="text-align: center">
	 		 <h4 style="font-weight: bold; padding-top: -13px">Employ Monthly Fee Slip</h4>
	 	</div>
	 	...
	 	<div class="col-md-12">
	 		<table style="width: 100%;" border="1" cellpadding="0" cellspacing="0">
	 			...
	 			<tr>
	 				<td  style="text-align: center;padding:3px" width="50%">Total Absence Day</td>
	 				<td  style="text-align: center;padding:3px">{{ $absence }} Day</td>
	 			</tr>


	 			<tr>
	 				<td  style="text-align: center;padding:3px" width="50%">Fainal Ammount</td>
	 				<td  style="text-align: center;padding:3px">{{ $final_ammount }} Taka</td>
	 			</tr>
