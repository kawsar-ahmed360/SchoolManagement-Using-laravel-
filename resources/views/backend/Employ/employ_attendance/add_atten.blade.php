                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Employe Attendance Add  <a href="{{ route('Employ_Attendanceview') }}" style="margin-left: 8px;" class="btn btn-success btn-sm"><i class="fa fa-list"></i> List Employe Attendace</a></h4>


                                         
                                         <form action="{{ route('Employ_AttendanceSave') }}" method="POST" accept-charset="utf-8">
                                           @csrf
                                    ...
                                    <table id="" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                   ...
                                                   @foreach($employ as $e)
                                                    <tr style="text-align: center">
                                                        ...
                                                        <td colspan="3">
                                                         ...
                                                         <span>Present</span>  <input style="margin-right: 8px" type="radio" style="font-size: 1px" class="attendace" name="attendance[{{ $e->id }}]" value="present" checked>
                                                         <span>Leave</span>  <input style="margin-right: 8px" type="radio" style="font-size: 1px" class="attendace" name="attendance[{{ $e->id }}]" value="leave">
                                                         <span>Absence</span>  <input type="radio" style="font-size: 1px" class="" name="attendance[{{ $e->id }}]" value="absence">
                                          ...
                                          <button type="submit" class="btn btn-success btn-sm">Attendance Take</button>     
