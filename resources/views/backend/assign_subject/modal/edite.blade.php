                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Add Assing Subject form  <a href="{{ route('AssignSubjectview') }}" style="margin-left: 8px;" class="btn btn-success btn-sm"><i class="fa fa-plus-circle"></i> View Assing subject</a></h4>
                                            ...
                                            <form action="{{ route('AssignSubjectupdate',$edite['0']->class_id) }}" method="post" accept-charset="utf-8">
                                                @csrf
                                                      <div class="full_item">
                                                  <div class="form-row">
                                               ...
                                               <div class="form-group col-md-5">
                                                   ...
                                                   <select class="form-control" name="class_id" id="class_id">
                                                       ...
                                                       @foreach($class as $c)
                                                       <option value="{{ $c->id }}" {{ ($edite['0']->class_id == $c->id)?"selected":"" }}>{{ $c->class_name }}</option>
                                                       @endforeach
                                                   </select>
                                               </div>
                                        ...
                                        @foreach($edite as $e)
                                               ...
                                               <div class="form-group col-md-4">
                                                   ...
                                                   <select class="form-control" name="subject_id[]" id="">
                                                       ...
                                                       <option value="{{ $s->id }}" {{ ($e->subject_id == $s->id)?"selected":"" }}>{{ $s->subject }}</option>
                                                       @endforeach
                                                   </select>
                                               </div>
                                                ...
                                                <div class="form-group col-md-2">
                                                   <label>Full Mark</label>
                                                    <input type="text" class="form-control" name="full_mark[]" value="{{ $e->full_mark }}" id="" placeholder="full mark.....">
                                               </div>

                                                <div class="form-group col-md-2">
                                                   <label>Pass Mark</label>
                                                    <input type="text" class="form-control" name="pass_mark[]" value="{{ $e->pass_mark }}" id="" placeholder="pass_mark.....">
                                               </div>

                                                <div class="form-group col-md-2">
                                                   <label>Get Mark</label>
                                                    <input type="text" class="form-control" name="get_mark[]" value="{{ $e->get_mark }}" id="" placeholder="get_mark.....">
                                               </div>
