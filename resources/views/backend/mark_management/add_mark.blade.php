...
<div class="col-12">
                ...
                <form action="{{ route('Employ_markEntySave') }}" method="POST" accept-charset="utf-8">
  ...
  @endif
	...
	$(document).on('click','#Search',function(){
       ...
       if (class_id && session_id && assing_subject_id && exam_type_id) {
         ...
         $.ajax({
         	url:"{{ route('Employ_assign_studentajax') }}",
         	type:"GET",
         	...
         	success:function(data){
         		...
         		$.each(data,function(key,v){
                  ...
                  '<tr style="text-align:center">'+
                     ...
                     '<td>'+v.name+'</td>'+
                     '<td>'+v.gender+'</td>'+
                     '<td><input type="text" name="marks[]" class="form-control-sm" value="" placeholder="Enty Mark"></td>'
                  +'</tr>';
