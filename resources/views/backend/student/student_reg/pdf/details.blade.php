	 ...
	 <div class="row">
	 	...
	 	<div class="col-md-12">
	 		<table style="width: 100%;" border="1" cellpadding="0" cellspacing="0">
	 			...
	 			<tr>
	 				<td  style="text-align: center;padding:3px" width="50%">Mother Name</td>
	 				<td  style="text-align: center;padding:3px">{{ $edite->mname }}</td>
	 			</tr>
	 			...
	 			<tr>
	 				<td  style="text-align: center;padding:3px" width="50%">Roll N0</td>
	 				<td  style="text-align: center;padding:3px">{{ $edite->student_id }}</td>
	 			</tr>
	 			...
	 			<tr>
	 				<td  style="text-align: center;padding:3px" width="50%">Date of Birdth</td>
	 				<td  style="text-align: center;padding:3px">{{ $edite->dob }}</td>
	 			</tr>
	 		</table>
