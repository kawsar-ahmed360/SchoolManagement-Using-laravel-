...
<div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                       ...
                                       <form action="{{ (@$edite)?route('Student_regupdate',$edite->student_id):route('Student_regSave') }}" method="post" accept-charset="utf-8" id="examadd" enctype="multipart/form-data">
					                      @csrf
