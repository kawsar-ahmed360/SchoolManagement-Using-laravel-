...
<div class="container">
	 ...
	 <div class="row">
	 	...
	 	<div class="col-md-12" style="text-align: center">
	 		 <h4 style="font-weight: bold; padding-top: -13px">Student Monthly Fee Slip</h4>
	 	</div>
	 	...
	 	<div class="col-md-12">
	 		<table style="width: 100%;" border="1" cellpadding="0" cellspacing="0">
	 			...
	 			<tr>
	 				<td  style="text-align: center;padding:3px" width="50%">Payment Month</td>
	 				<td  style="text-align: center;padding:3px">{{ $month }}</td>
	 			</tr>

	 			<tr>
	 				<td  style="text-align: center;padding:3px" width="50%">Monthly Fee</td>
	 				<td  style="text-align: center;padding:3px">{{ $monthlyfee->ammount }} Taka</td>
	 			</tr>
