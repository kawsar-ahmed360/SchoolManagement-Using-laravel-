<div class="modal fade" id="session" tabindex="-1" style="display: none"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
             ...
             <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('studentyearSave') }}" method="post" accept-charset="utf-8" id="addsession">
                      @csrf
